...
%>
    ...
    <!--<form id="frmdashboard" method="post" enctype="multipart/form-data" action="http://10.4.109.63:8080/upload">-->
        <!--<form method="POST" enctype="multipart/form-data" action="http://10.4.109.63:8080/upload">-->
           <form method="POST" enctype="multipart/form-data" action="http://ec2-34-227-222-250.compute-1.amazonaws.com:5000/api/imageprocessor/receiveFile?sessionId=123">
            <!--<form>-->
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div>
                                                            <div>
                                                                <table>
                                                                    <tr><td>File to upload:</td><td><input id="fileinput" type="file" name="file" /></td><td><input type="submit" value="Upload" /></td></tr>
                ...
                <div class="popup-box chat-popup nav-brand" id="qnimate"><h4 class="nav-page-name">Jarvis Support Bot</h4>
                    ...
                    <div class="popup-head nav-brand">
                        <div id="powerSummaryPanel1">
                            ...
                            <!--Custom Chatbot-->
                            <iframe id="ifapiai" width="335" height="430" src="apiai.html"></iframe>
